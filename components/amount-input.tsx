    ...
    <div className="relative">
        ...
        <Tooltip delayDuration={100}>
          <TooltipTrigger asChild>
            <button
              ...
              className={cn(
                "absolute bg-slate-400 hover:bg-slate-500 top-1.5 left-1.5",
      ...
      <CurrencyInput
        ...
        className={cn(
          ...
          "pl-10 file:text-sm file:font-medium placeholder:text-muted-foreground",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
          "focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
        )}
      />
      <p className="text-xs text-muted-foreground mt-2">
        {isIncome && "Está adicionando uma receita"}
        {isExpense && "Está adicionando uma despesa"}
      </p>
    </div>
  );
};
